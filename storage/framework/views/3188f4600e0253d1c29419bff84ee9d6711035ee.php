    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-8 offset-0 offset-sm-0 offset-md-2">
            ...
            <form method="POST" action="<?php echo e(route('contact-form-process')); ?>" name="report-content-form">
                ...
                <input type="submit" name="reportSbtn" value="<?php echo app('translator')->get('v192.contact-us'); ?>" class="btn btn-danger">
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u748092880/domains/bemysimp.com/public_html/resources/views/contact-page.blade.php ENDPATH**/ ?>