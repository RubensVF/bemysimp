...
} elseif ($_instance->childHasBeenRendered('TVRfHon')) {
    $componentId = $_instance->getRenderedChildComponentId('TVRfHon');
    $componentTag = $_instance->getRenderedChildComponentTagName('TVRfHon');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TVRfHon');
} else {
    $response = \Livewire\Livewire::mount('user-cards');
    $dom = $response->dom;
    $_instance->logRenderedChild('TVRfHon', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php echo $__env->make( 'account' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u748092880/domains/bemysimp.com/public_html/resources/views/billing/cards.blade.php ENDPATH**/ ?>