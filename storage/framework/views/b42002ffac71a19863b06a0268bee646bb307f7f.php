<div>
    <div class="p-relative">
        <input class="form-control search-topnavi mt-2 mr-sm-2 <?php if(auth()->guest()): ?> search-guest <?php else: ?> search-logged-in <?php endif; ?>" type="search" placeholder="<?php echo app('translator')->get('general.searchCreator'); ?>" aria-label="Search" wire:model.debounce.200ms="search">
...
<?php /**PATH /home/u748092880/domains/bemysimp.com/public_html/resources/views/livewire/search-creators.blade.php ENDPATH**/ ?>