<?php $__env->startSection('seo_title'); ?> Crypto (CoinPayments) - <?php $__env->stopSection(); ?>
...
<div class="row">
	<div class="col-12 col-sm-12 col-md-6 offset-0 offset-sm-0 offset-md-3">
		<div class="card shadow-sm">
            ...
            <input type="hidden" name="amountf" value="<?php echo e(number_format($user->profile->finalPrice,2)); ?>">
            <input type="hidden" name="item_name" value="1 Month Subscription to <?php echo e($user->profile->username); ?>">
            <input type="hidden" name="ipn_url" value="<?php echo e(route('coinPaymentsProcessing', ['creator' => $user->id, 'subscriber' => auth()->id()])); ?>"/>
            <input type="hidden" name="success_url" value="<?php echo e(route('feed')); ?>"/>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/patrons/resources/views/subscribe/crypto-coinpayments.blade.php ENDPATH**/ ?>