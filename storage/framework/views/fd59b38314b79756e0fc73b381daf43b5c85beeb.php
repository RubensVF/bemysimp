			...
			<?php if($profile->monthlyFee): ?>
				...
				<?php else: ?>
					...
					<div class="dropdown-menu" aria-labelledBy="premiumPostsLink">
						...
						<?php if(opt('card_gateway', 'Stripe') == 'Crypto'): ?>
							<a class="dropdown-item" href="<?php echo e(route('subscribeCoinPayments', [ 'user' => $profile->user->id ])); ?>">
								<?php echo app('translator')->get('v192.crypto'); ?>
							</a>
						<?php endif; ?>
					</div>
					</div>
...
} elseif ($_instance->childHasBeenRendered('oh3Vind')) {
    $componentId = $_instance->getRenderedChildComponentId('oh3Vind');
    $componentTag = $_instance->getRenderedChildComponentTagName('oh3Vind');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oh3Vind');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('oh3Vind', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<div class="col-12 col-md-4 d-none d-sm-none d-md-block d-lg-block">
	...
	<?php if( $feed->count() ): ?>
		<input class="lastId d-none" value="<?php echo e($feed->last()->id); ?>" type="number"/>
	<?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u748092880/domains/bemysimp.com/public_html/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>