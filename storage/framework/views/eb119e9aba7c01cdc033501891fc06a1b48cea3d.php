...
} elseif ($_instance->childHasBeenRendered('aFXDJQS')) {
    $componentId = $_instance->getRenderedChildComponentId('aFXDJQS');
    $componentTag = $_instance->getRenderedChildComponentTagName('aFXDJQS');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aFXDJQS');
} else {
    $response = \Livewire\Livewire::mount('notifications-icon');
    $dom = $response->dom;
    $_instance->logRenderedChild('aFXDJQS', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                        </li>
...
} elseif ($_instance->childHasBeenRendered('jV74T6T')) {
    $componentId = $_instance->getRenderedChildComponentId('jV74T6T');
    $componentTag = $_instance->getRenderedChildComponentTagName('jV74T6T');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jV74T6T');
} else {
    $response = \Livewire\Livewire::mount('unread-messages-count');
    $dom = $response->dom;
    $_instance->logRenderedChild('jV74T6T', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                        </li>
...
} elseif ($_instance->childHasBeenRendered('BcmYuOu')) {
    $componentId = $_instance->getRenderedChildComponentId('BcmYuOu');
    $componentTag = $_instance->getRenderedChildComponentTagName('BcmYuOu');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BcmYuOu');
} else {
    $response = \Livewire\Livewire::mount('search-creators');
    $dom = $response->dom;
    $_instance->logRenderedChild('BcmYuOu', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                </ul>
