...
<div class=" col-sm-11 col-md-11 col-12">
	...
	<a href="<?php echo e(route('profile.show', ['username' => $comment->commentator->profile->username ])); ?>" class="comment-user">
		<?php echo e($comment->commentator->name); ?>

	</a> <small class="text-secondary"><?php echo e($comment->created_at->diffForHumans()); ?></small><br>

	<div class="text-wrap comment-content mt-1" data-id="<?php echo e($comment->id); ?>" data-post="<?php echo e($comment->commentable->id); ?>">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /Users/crivion/Sites/patrons/resources/views/posts/comments.blade.php ENDPATH**/ ?>