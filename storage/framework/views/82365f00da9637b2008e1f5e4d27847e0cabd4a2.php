...
} elseif ($_instance->childHasBeenRendered('fO5OcGe')) {
    $componentId = $_instance->getRenderedChildComponentId('fO5OcGe');
    $componentTag = $_instance->getRenderedChildComponentTagName('fO5OcGe');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fO5OcGe');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('fO5OcGe', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
