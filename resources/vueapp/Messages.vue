                  ...
                  <div class="media">
                    <i>
                      <a href="javascript:void(0)" @click="openConversation(user.id)">
                        <img :src="'/uploads/' + user.profile.profilePic" alt="">
                      </a>
                    </i>
          ...
          <div class="tabcontains">
            <div class="smshead">
              <div class="slctAdb">
                <div class="media">
                  <i v-if="activeChat">
                    <img :src="'/uploads/' + activeRecipient.profile.profilePic" alt="">
                  </i>
                  <div class="media-body">
            ...
            <div v-if="activeChat" v-chat-scroll class="smscontRt">
              <div class="smscontRtBox">
                <div v-for="m in messages" :key="'msg'+m.id" :class="{'fxrt': m.receiver.id != activeChat}"
                     class="chtSMSRw">
                  <div class="media">
                    <i><img :src="'/uploads/' + m.sender.profile.profilePic" alt=""></i>
                    <div class="media-body">
                      <strong>{{ m.message }}
            ...
            <div v-if="activeChat">
              ...
              <div class="text-right mr-2">
                <a class="mr-2" href="javascript:void(0)" @click="switchCost()" v-if="price != 0 && authUser.profile.isVerified === 'Yes'">
                  {{setFreeTranslated }}
                </a>

                <input v-model="price" class="messageCost" type="number" v-if="price != 0 && authUser.profile.isVerified === 'Yes'">

                <a class="mr-2" href="javascript:void(0)" @click="switchCost()" v-if="price < 1 && authUser.profile.isVerified === 'Yes'">
                  {{ setPriceTranslated }}
                </a>
        ...
        'price': vm.price
          ...
          .then(function (response) {
            ...
            if (vm.attachments.length > 0) {
              ...
              vm.openConversation(vm.activeChat);
            }
